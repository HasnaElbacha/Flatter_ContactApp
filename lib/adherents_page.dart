...
class _AdListState extends State<AdList> {
  final List<Adherent> ads = [
    Adherent(firstName: "Hasna", lastName: "EL BACHA", age: 21),
    Adherent(firstName: "Asma", lastName: "EL BACHA", age: 21),
  ];
                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => AdherentDetailScreen(adherent: ad), // Passer l'adhérent sélectionné à l'écran détaillé
                      ),
                    );
                  },
                  child: Card(
